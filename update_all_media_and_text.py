...
# 1. GENERATE RICH OFFERS DATA WITH PERFECT CATALAN AND HD VERIFIED IMAGES
rich_offers = {
    "costa-oest": {
        ...
        "itinerary": [
            {"day": "DIA 01", "title": "Barcelona - Los Angeles", "desc": "Vol cap a Los Angeles. Recollida del vehicle de lloguer a l'aeroport i trasllat a l'hotel."},
            {"day": "DIA 02-03", "title": "Los Angeles", "desc": "Explora el passeig de la fama a Hollywood, Beverly Hills, el moll de Santa Monica i Venice Beach."},
            ...
            {"day": "DIA 05", "title": "Grand Canyon - Monument Valley", "desc": "Submergeix-te en el paisatge icònic de l'Oest entre les majestuoses torres de sorra vermella."},
            {"day": "DIA 06-07", "title": "Monument Valley - Las Vegas", "desc": "Arribada a la capital mundial de l'entreteniment i els llums de neó."},
            {"day": "DIA 08", "title": "Las Vegas - Death Valley", "desc": "Creua el desert de la Vall de la Mort amb vistes espectaculars a Zabriskie Point."},
            ...
            {"day": "DIA 11-13", "title": "Yosemite - San Francisco", "desc": "Visita a la ciutat dels turons, el Golden Gate, el tramvia històric i entrada inclosa a l'illa d'Alcatraz."},
            {"day": "DIA 14-16", "title": "San Francisco - St. Luis Obispo - Los Angeles - BCN", "desc": "Retorn panoràmic per la costa de Califòrnia (Highway 1) i vol de tornada a Barcelona."}
        ],
        "included": [
    ...
    "aurores": {
        ...
        "itinerary": [
            {"day": "DIA 01", "title": "Barcelona - Oslo - Tromsø", "desc": "Vols a Tromsø, la capital de les aurores boreals. Trasllat privat a l'hotel."},
            {"day": "DIA 02", "title": "Tromsø & Cerca d'Aurores", "desc": "Visita de la ciutat i excursió nocturna guiada amb fotògraf expert per observar les llums del nord."},
            {"day": "DIA 03", "title": "Safari en trineu de gossos husky", "desc": "Aventura inoblidable conduint el teu propi trineu de huskies a través de les valls àrtiques nevades."},
            {"day": "DIA 04", "title": "Navegació pels fiords àrtics", "desc": "Creuer panoràmic entre majestuosos fiords noruecs amb possibilitat d'avistar faunes locals."},
    ...
    "bali": {
        ...
        "itinerary": [
            {"day": "DIA 01-02", "title": "Barcelona - Denpasar - Ubud", "desc": "Vol cap a Bali. Arribada al cor cultural d'Ubud entre boscos tropicals i santuaris."},
            ...
            {"day": "DIA 05", "title": "Ubud - Trajecte a Gili Trawangan", "desc": "Trasllat al port i trajecte en vaixell ràpid cap al paradís sense cotxes de les Illes Gili."},
            {"day": "DIA 06-08", "title": "Platges i immersió a Gili Trawangan", "desc": "Dies de relaxació, immersió amb tortugues marines, postes de sol mítiques i sopars a la sorra."},
            {"day": "DIA 09-10", "title": "Gili Trawangan - Denpasar - Barcelona", "desc": "Retorn en vaixell a Bali i vol de tornada a Barcelona."}
        ],
        "included": [
    ...
    "londres": {
        ...
        "itinerary": [
            {"day": "DIA 01", "title": "Barcelona - Londres", "desc": "Vol a Londres. Trasllat privat a l'hotel. Passeig per Piccadilly Circus, Leicester Square i el barri de Soho."},
            {"day": "DIA 02", "title": "Westminster & London Eye", "desc": "Visita al palau de Buckingham, Big Ben, abadia de Westminster i pujada inclosa a la nòria London Eye."},
            {"day": "DIA 03", "title": "Camden Town & Museu Britànic", "desc": "Matí al mercat alternatiu de Camden. Per la tarda, visita al Museu Britànic i tast gastronòmic a Borough Market."},
    ...
    "argentina": {
        ...
        "itinerary": [
            ...
            {"day": "DIA 09-11", "title": "Buenos Aires - Barcelona", "desc": "Última nit a Buenos Aires amb sopar espectacle de tango opcional i vol de retorn a Barcelona."}
        ],
        "included": [
    ...
    "timisoara": {
        ...
        "itinerary": [
            ...
            {"day": "DIA 02", "title": "Centre històric & Plaça de la Victòria", "desc": "Visita guiada a la Catedral Ortodoxa, el Palau Lloyd, la Plaça de la Llibertat i l'arquitectura Secession."},
    ...
    "roma": {
        ...
        "itinerary": [
            ...
            {"day": "DIA 02", "title": "Colosseu, Fòrum Romà & Palatí", "desc": "Visita monumental a les restes de l'Imperi Romà i tarda gastronòmica al barri de Trastevere."},
    ...
    "thailandia": {
        ...
        "itinerary": [
            ...
            {"day": "DIA 06-08", "title": "Chiang Mai & muntanyes del Nord", "desc": "Vol al nord. Excursió d'un dia amb senderisme, cascades, santuari d'elefants ètic i mercat nocturn."},
            {"day": "DIA 09-12", "title": "Illes de Krabi & Phi Phi Islands", "desc": "Vol a Krabi. Dies de relaxació en platges de sorra blanca, immersió i excursió en barca a Phi Phi."},
...
with open('offers_data.js', 'w', encoding='utf-8') as f:
    f.write('const offersData = ' + json.dumps(rich_offers, indent=4, ensure_ascii=False) + ';\n')
print('Updated offers_data.js')

# Update index.html to replace broken Monument Valley URL
with open('index.html', 'r', encoding='utf-8') as f:
    html = f.read()

html = html.replace('https://images.unsplash.com/photo-1518457607834-6e8d80b48ce8', 'https://images.unsplash.com/photo-1541781774459-bb2af2f05b55')
html = html.replace('https://images.unsplash.com/photo-1506665531195-3566fe2966e4', 'https://images.unsplash.com/photo-1563492065599-3520f775eeed')
html = html.replace('https://images.unsplash.com/photo-1578305421596-9104085b3127', 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5')
